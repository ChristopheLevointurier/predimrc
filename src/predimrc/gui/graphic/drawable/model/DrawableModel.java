...
public class DrawableModel extends DrawableModelElement implements IModelListener, Iterable<DrawableWing> {
    ...
    public void computePositions() {
        ...
        double Vs = (XDs * stab.getArea() * Math.cos(stab.get(0).getDiedre() * Math.PI / 180) * Math.cos(stab.get(0).getDiedre() * Math.PI / 180)) / (mainWing.getMeanCord() * mainWing.getArea());  //stab volume
        ...
        double xF = 0.25 + (XDs * stab.getArea() * Math.cos(stab.get(0).getDiedre() * Math.PI / 180) * Math.cos(stab.get(0).getDiedre() * Math.PI / 180) * As * (1 - E) - XDf * getFuselage().getArea() * Af) / (mainWing.getMeanCord() * (mainWing.getArea() * Aa + getFuselage().getArea() * Af + stab.getArea() * Math.cos(stab.get(0).getDiedre() * Math.PI / 180) * Math.cos(stab.get(0).getDiedre() * Math.PI / 180) * As * (1 - E)));
