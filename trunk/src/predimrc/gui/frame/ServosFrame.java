 ...
 * @since 
 */
public class ServosFrame extends ExternalFrame{

     public ServosFrame(AbstractButton _caller)
    {
        this(_caller, predimrc.PredimRC.icon, predimrc.PredimRC.DEFAULT_X_FRAME, predimrc.PredimRC. DEFAULT_Y_FRAME);
    }

    public ServosFrame(AbstractButton _caller, Image _icon, int _x, int _y) {
