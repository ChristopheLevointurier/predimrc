 ...
 * @since
 */
public class VlmStab_Frame extends ExternalFrame {

    public VlmStab_Frame(AbstractButton _caller) {
        this(_caller, predimrc.PredimRC.icon, Utils.DEFAULT_X_FRAME, Utils.DEFAULT_Y_FRAME);
    }

    public VlmStab_Frame(AbstractButton _caller, Image _icon, int _x, int _y) {
