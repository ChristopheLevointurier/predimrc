...
/**
 * Interface representing a 3D displayable structure. A
 * <code>JGL_3DStruct</code> object can be contained by a
 * <code>JGL_3DMovable</code> object, and can be insert in a
 * <code>JGL_3DBsp</code> tree.
 *
...
public interface JGL_3DStruct {
    ...
    /**
     * Displays the structure according to the specified vision cone (an eye
     * position and 4 points to make a 4 sides pyramid).
     *
